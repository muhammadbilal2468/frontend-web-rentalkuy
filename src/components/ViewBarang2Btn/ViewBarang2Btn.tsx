...
import "./ViewBarang2Btn.css";

interface ViewBarang2BtnProps {
  visible: boolean;
  data?: Photo;
  onClose: () => void;
}

const ViewBarang2Btn: React.FC<ViewBarang2BtnProps> = (props) => {
  const { visible, onClose } = props;
  if (!visible) return <></>;

  return (
    <div className="vb2btn">
      <div className="vb2btn-box">
